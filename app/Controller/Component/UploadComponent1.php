...
class UploadComponent extends Component {
	...
	*/
	...
	protected function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
		// Creates new object representing uploaded file or chunk
		$file = new stdClass();
		...
		// Proceeds in file uploading only if no error has been found
		if (!$error && $file->name) {
	...
	public function post() {
		...
		// Echoes json instead of returning it
		echo $json;
	}
