...
class DATABASE_CONFIG {
	...
	// main database of orcae_upload
	public $orcae_upload = array(
		'datasource' => 'Database/Mysql',
		'persistent' => false,
		'host' => 'localhost',
		'login' => 'root',
		'password' => '',
		'database' => 'orcae_upload',
		'prefix' => '',
		//'encoding' => 'utf8',
	);

	// main database of orcae
	public $orcae_bogas = array(
		'datasource' => 'Database/Mysql',
		'persistent' => false,
		'host' => 'localhost',
		'login' => 'root',
		'password' => '',
		'database' => 'orcae_bogas',
		'prefix' => '',
		//'encoding' => 'utf8',
	);
